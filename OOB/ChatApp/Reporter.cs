...
namespace ChatApp
{
    ...
    {
        private static readonly string pathwayLog = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\\ChatApp\\Log\\";
        private static readonly string filenameLog = "Log";
        private static readonly string filetypeLog = ".txt";

        private static readonly string pathwayError = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\\ChatApp\\Error\\";
